...
desc 'Generate documentation for the taxonomy_based_pricing extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'TaxonomyBasedPricingExtension'
...
desc 'Test the taxonomy_based_pricing extension.'
